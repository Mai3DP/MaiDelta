...
#define STRING_CONFIG_H_AUTHOR "(Simone, default config)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "MaiDelta"
...
#define DELTA
  ...
  #define DELTA_DIAGONAL_ROD 300.3        // (mm)

  // Distance between bed and nozzle Z home position
  #define DELTA_HEIGHT 426.00             // (mm) Get this value from G33 auto calibrate

  #define DELTA_ENDSTOP_ADJ { 0.0, 0.0, 0.0 } // Get these values from G33 auto calibrate

  // Horizontal distance bridged by diagonal push rods when effector is centered.
  #define DELTA_RADIUS 157.1              // (mm) Get this value from G33 auto calibrate
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   { DEFAULT_XYZ_STEPS_PER_UNIT, DEFAULT_XYZ_STEPS_PER_UNIT, DEFAULT_XYZ_STEPS_PER_UNIT, 166.1 }  // default steps per unit for Kossel (GT2, 20 tooth)
